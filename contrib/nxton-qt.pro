...
RESOURCES += src/qt/nxton.qrc src/qt/nxton_locale.qrc

TRANSLATIONS += src/qt/locale/nxton_bg.ts \
                src/qt/locale/nxton_de.ts \
                src/qt/locale/nxton_en.ts \
                src/qt/locale/nxton_es.ts \
                src/qt/locale/nxton_fi.ts \
                src/qt/locale/nxton_fr.ts \
                src/qt/locale/nxton_it.ts \
                src/qt/locale/nxton_ja.ts \
                src/qt/locale/nxton_pl.ts \
                src/qt/locale/nxton_pt.ts \
                src/qt/locale/nxton_ru.ts \
                src/qt/locale/nxton_sk.ts \
                src/qt/locale/nxton_sv.ts \
                src/qt/locale/nxton_vi.ts \
                src/qt/locale/nxton_zh_CN.ts \
                src/qt/locale/nxton_zh_TW.ts

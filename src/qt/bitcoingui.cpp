                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("NextON Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a NXTON address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and nxton: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zNXTON"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About NextON Core"), this);
    aboutAction->setStatusTip(tr("Show information about NextON Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for NXTON"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your NXTON addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified NXTON addresses"));
    ...
    openAction->setStatusTip(tr("Open a NXTON: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the NextON Core help message to get a list with possible NXTON command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("NextON Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to NXTON network", "", count));
}
...
{
    QString strTitle = tr("NextON Core"); // default title
...
/** Creates context menu, its actions, and nxtons up all the relevant signals for mouse events. */

...
/** Utility functions used by the NXTON Qt UI.
 */
namespace GUIUtil
{
...
// Render NXTON addresses in monospace font
...
// Parse "nxton:" URI into recipient object, return true on successful parsing

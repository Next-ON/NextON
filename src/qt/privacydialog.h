...
public:
    ...
    void setZNXTONControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzNXTON_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzNXTON_clicked();
    void on_pushButtonZNXTONControl_clicked();

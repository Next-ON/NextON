...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* NXTON features */
        {"nxton", "masternode", &masternode, true, true, false},
        {"nxton", "listmasternodes", &listmasternodes, true, true, false},
        {"nxton", "getmasternodecount", &getmasternodecount, true, true, false},
        {"nxton", "masternodeconnect", &masternodeconnect, true, true, false},
        {"nxton", "masternodecurrent", &masternodecurrent, true, true, false},
        {"nxton", "masternodedebug", &masternodedebug, true, true, false},
        {"nxton", "startmasternode", &startmasternode, true, true, false},
        {"nxton", "createmasternodekey", &createmasternodekey, true, true, false},
        {"nxton", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"nxton", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"nxton", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"nxton", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"nxton", "getmasternodescores", &getmasternodescores, true, true, false},
        {"nxton", "mnbudget", &mnbudget, true, true, false},
        {"nxton", "preparebudget", &preparebudget, true, true, false},
        {"nxton", "submitbudget", &submitbudget, true, true, false},
        {"nxton", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"nxton", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"nxton", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"nxton", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"nxton", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"nxton", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"nxton", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"nxton", "checkbudgets", &checkbudgets, true, true, false},
        {"nxton", "mnsync", &mnsync, true, true, false},
        {"nxton", "spork", &spork, true, true, false},
        {"nxton", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"nxton", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use nxtond, or the -server option to nxton-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> nxton-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:32699/\n";
}

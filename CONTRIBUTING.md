Contributing to NextON Core
============================

The NextON Core project operates an open contributor model where anyone is
...
The following applies to code changes to the NextON Core project, and is not to be
confused with overall NXTON Network Protocol consensus changes.

Whether a pull request is merged into NextON Core rests with the project merge
...
Patches that change NXTON consensus rules are considerably more involved than
...
Where a patch set proposes to change the NXTON consensus, it must have been
...
The project leader is the release manager for each NextON Core release.

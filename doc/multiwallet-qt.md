...
In order to support loading of multiple wallets in nxton-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is nxton.cpp.
...
Changes to nxton.cpp
----------------------
nxton.cpp is the entry point into nxton-qt, and as such, will require some minor modifications to provide hooks for
